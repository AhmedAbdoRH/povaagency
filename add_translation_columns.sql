-- =====================================================
-- إضافة أعمدة الترجمة الإنجليزية لجميع الجداول
-- Add English translation columns to all tables
-- =====================================================

-- Add English columns to pages table
ALTER TABLE pages 
...
-- Add English columns to specializations table
ALTER TABLE specializations
ADD COLUMN IF NOT EXISTS name_en TEXT,
ADD COLUMN IF NOT EXISTS description_en TEXT;

-- Add English columns to clients table
ALTER TABLE clients
ADD COLUMN IF NOT EXISTS name_en TEXT,
ADD COLUMN IF NOT EXISTS description_en TEXT;

-- =====================================================
-- تحديث البيانات بالترجمات الإنجليزية
-- Update data with English translations
-- =====================================================
