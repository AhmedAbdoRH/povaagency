    ...
    <section ref={sectionRef} className="relative bg-[#f8f9fa] py-24">
      ...
      <div className="container relative z-10 mx-auto px-4 w-full">
        <div className="mb-16 md:mb-24 flex flex-col items-center text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-[#162341] mb-6">
            {(t('companyValues.heading').split('\n')).map((line, i) => (
              <span key={i} className="block mb-4 last:mb-0">{line}</span>
            ))}
          </h2>
          <p className="text-xl text-[#162341] max-w-2xl mx-auto font-medium">
            ...
            {[...values, ...values].map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-2xl font-black text-[#162341] mb-4">{value.title}</h3>
                  <p className="text-[#162341] text-lg leading-relaxed font-medium">
                    {value.description}
                  </p>
                </div>
              );
