...
const emptyContentForm = { client_id: '', title: '', description: '', image_url: '', video_url: '', is_vertical_video: false, content_type: 'image' as 'image' | 'video' | 'text' };
